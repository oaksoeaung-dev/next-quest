...
export default function Page() {
    ...
    return (
        <div>
            ...
            <h1 className={"text-2xl text-zinc-700 font-semibold"}>Posts</h1>
            <ul className={"mt-10 space-y-5 max-w-sm"}>
                {
                    posts.map((post) => (
                        <li key={post.id} className={"p-5 rounded-lg text-zinc-700 bg-zinc-100 flex justify-between items-center"}>
                            <span>{post.post}</span>
